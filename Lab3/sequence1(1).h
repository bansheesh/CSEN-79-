...
//
//  void last();
//      Poscondition: The iterator is reset to CAPACITY - 1, regardless of the
//      numebr of items in the sequence;
//
// void advance();
...
//
// void retreat();
//      Postcondition: The iterator's value is reduced by 1, unless it is
//      already at the beginning of the sequence.
//
//
...
//      from the sequence, and the current item points at the front of the
//      sequence.
//
//   void operator +=(const sequence& lhs, const sequence& rhs)
//     Postcondition: Adds the items of rhs to the lhs. Also returns a copy of
//     lhs.
//
//
...
//      Precondtion: isitem() returns true
//      Poscondition: Returns the item in the sequence at the current position
//      of the iterator.
//
...
//
//   double mean() const
//     Postcondition: The value returned is the mean of the values stored in the
//     sequence.
//
//   double standardDeviation() const
//     Postcondition: The value returned is the stadard deviation of the values
...
//     Postcondition: The value returned is the summation of the values stored
//     in the sequence s.
//
//
