...
namespace coen79_lab9
{
    ...
    // Library facilities used: cstdlib
    {
        ...
        {
          // STUDENT WORK
          inorder(f, node_ptr->left()); //shift left, root, then right
          f(node_ptr->data());
    ...
    // Library facilities used: cstdlib
    {
        // STUDENT WORK
      if(node_ptr != NULL){
        postorder(f, node_ptr->left()); //shift left, right, then root
    ...
    // Library facilities used: cstdlib
    {
        // STUDENT WORK
      if(node_ptr != NULL){
        f(node_ptr->data()); //shift root, left, then right
    ...
    // Library facilities used: cstdlib
    {
        ...
        if (root_ptr != NULL)
        {
          ...
          // STUDENT WORK
          child = root_ptr->right(); //clear right children
          tree_clear(child);

          delete root_ptr; //delete root and set ptr to NULL
          root_ptr = NULL;
        }
    }
    ...
    // Library facilities used: cstdlib
    {
        ...
        {
            // STUDENT WORK
          l_ptr = tree_copy(root_ptr->left()); //copy left and right
          r_ptr = tree_copy(root_ptr->right());
        }
      return new binary_tree_node<Item>(root_ptr->data(), l_ptr, r_ptr); //return new node
    }
    ...
    // Library facilities used: cstdlib
    {
        if (node_ptr == NULL)
            ...
            // STUDENT WORK
          return (tree_size(node_ptr->left()) + 1 + tree_size(node_ptr->right())); //return tree size
    }
}
