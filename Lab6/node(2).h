...
//
//   void list_insert_at(Node*& head_ptr, const node::value_type& entry, size_t
//   position)
//     Precondition: head_ptr is the head pointer of a linked list, and
...
//     Example: If the list contains 1,1,1,2, after running this function the
//     list contains 1,2
//
//   void list_print (const node* head_ptr);
//     Precondition: head_ptr is the head pointer of a linked list, and
//     the operator << has been defined for the value_type
//     Postcondition: The value_type of all the nodes in the linked list are
//     printed
//
